...
if __name__ == '__main__':
    ...
    Tree.Insert(Record(1, 1, (1, 1)))
    print("-----------")
    Tree.print_tree(Tree.root)
    input()
    Tree.Insert(Record(2, 1, (2, 1)))
    print("-----------")
    Tree.print_tree(Tree.root)
    input()
    Tree.Insert(Record(3, 1, (3, 4)))
    print("-----------")
    Tree.print_tree(Tree.root)
    input()
    Tree.Insert(Record(4, 2, (1, 2)))
    print("-----------")
    Tree.print_tree(Tree.root)
    input()
    Tree.Insert(Record(4, 2, (10, 5)))
    print("-----------")
    Tree.print_tree(Tree.root)
    input()
    Tree.Insert(Record(4, 2, (1, 5)))
    print("-----------")
    Tree.print_tree(Tree.root)
    input()
    Tree.Insert(Record(4, 2, (1, 6)))
    print("-----------")
    Tree.print_tree(Tree.root)
